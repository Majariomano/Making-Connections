...
// The first variable here sets up the Analog Pin fo the potentiometer
int analog_pin = 0;

// This variable is set up to read the current value read
//from the potentiometer
int current_value;

//This variable is set up to read the previous value 
// from the potentiometer
int previous_value;
...
// These lines of code set up the range and smooth out the 
//transitions as the pitchbend control is used. 
...
//This section reads and outputs the midi note, updating the note pitch
//while the pitchbend control is being used. 
  current_value = analogRead(analog_pin);
  if(current_value != previous_value) {
    previous_value = current_value;
    usbMIDI.sendPitchBend(current_value, 1);
  }
